...
- [ ] **Step 1: Add a failing entry/confirmation test**
...
- [ ] **Step 2: Add a failing successful-return test**
...
- [ ] **Step 3: Run the widget test and verify RED**
...
- [ ] **Step 1: Remove the app-invented method model**
...
- [ ] **Step 2: Make Continue depend only on the loaded plan**
...
- [ ] **Step 3: Add the non-interactive provider card**
...
- [ ] **Step 4: Make the success page provider-specific rather than method-specific**
...
- [ ] **Step 5: Run the widget test and verify GREEN**
...
- [ ] **Step 6: Commit the tested payment presentation change**
...
- [ ] **Step 1: Add failing Vietnamese localization expectations**
...
- [ ] **Step 3: Add the translations and remove unreachable copy**
...
- [ ] **Step 4: Run the localization and payment tests and verify GREEN**
...
- [ ] **Step 5: Commit the tested localization cleanup**
...
- [ ] **Step 1: Search for misleading or dead payment UI copy**
...
- [ ] **Step 2: Run targeted payment and localization tests**
