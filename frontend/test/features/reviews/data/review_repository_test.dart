...
void main() {
  test(
    'loadReviews sends page, pageSize, and optional rating filter',
    () async {
      Object? capturedBody;
  ...
  test(
    'loadSummary sends content reference and parses rating counts',
    () async {
      Object? capturedBody;
      final ReviewRepository repository = ReviewRepository(
        functionClient: SupabaseFunctionClient(
  ...
  test(
    'upsertReview forwards review fields and parses refreshed result',
    () async {
      Object? capturedBody;
      final ReviewRepository repository = ReviewRepository(
        functionClient: SupabaseFunctionClient(
