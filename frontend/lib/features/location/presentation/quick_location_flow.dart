...
class QuickLocationFlow {
  ...
  }) : _deviceLocationService = deviceLocationService ?? DeviceLocationService(),
  ...
  Future<_LocationDraft?> _captureGpsDraft(BuildContext context) async {
    final LocationPermission initialPermission =
        await _deviceLocationService.checkPermission();
    ...
    if (permission == LocationPermission.denied ||
      ...
      if (choice == _PermissionPromptChoice.manual) {
        return _openManualEditor(context, seed: null, source: LocationSource.manual);
      }
    ...
    final bool serviceEnabled =
        await _deviceLocationService.isLocationServiceEnabled();
    if (!serviceEnabled) {
      if (!context.mounted) return null;
    ...
    try {
      final ResolvedLocationData gpsData =
          await _deviceLocationService.getCurrentGpsLocation();
  ...
  Future<void> _savePreference(BuildContext context, _LocationDraft draft) async {
    try {
  ...
  Future<void> _confirmAndPersist(BuildContext context, _LocationDraft draft) async {
  ...
  Future<_ConfirmationAction> _showConfirmationSheet(
    ...
    final _ConfirmationAction? action =
        await showModalBottomSheet<_ConfirmationAction>(
          context: context,
              ...
              onPressed: () {
                ...
                Navigator.of(dialogContext).pop(
                  _LocationDraft(
                    latitude: lat,
                    longitude: lng,
                    approxAddress: address.isEmpty ? 'Manual location' : address,
  ...
  Future<_PermissionPromptChoice> _showPermissionPurposeDialog(
    ...
    final _PermissionPromptChoice? value =
        await showDialog<_PermissionPromptChoice>(
          context: context,
          builder: (BuildContext dialogContext) {
            return AlertDialog(
              ...
              actions: <Widget>[
                TextButton(
                  onPressed: () => Navigator.of(dialogContext).pop(
                    _PermissionPromptChoice.manual,
                  ),
                  child: const Text('Enter Manually'),
                ),
                TextButton(
                  onPressed: () => Navigator.of(dialogContext).pop(
                    _PermissionPromptChoice.cancel,
                  ),
                  child: const Text('Cancel'),
                ),
                FilledButton(
                  onPressed: () => Navigator.of(dialogContext).pop(
                    _PermissionPromptChoice.continueRequest,
                  ),
  ...
  Future<_PermissionBlockedChoice> _showPermissionBlockedDialog(
    ...
    final _PermissionBlockedChoice? value =
        await showDialog<_PermissionBlockedChoice>(
          context: context,
          builder: (BuildContext dialogContext) {
            return AlertDialog(
              ...
              actions: <Widget>[
                TextButton(
                  onPressed: () => Navigator.of(dialogContext).pop(
                    _PermissionBlockedChoice.manual,
                  ),
                  child: const Text('Enter Manually'),
                ),
                TextButton(
                  onPressed: () => Navigator.of(dialogContext).pop(
                    _PermissionBlockedChoice.cancel,
                  ),
                  child: const Text('Cancel'),
                ),
                FilledButton(
                  onPressed: () => Navigator.of(dialogContext).pop(
                    _PermissionBlockedChoice.settings,
                  ),
  ...
  Future<_ServiceDisabledChoice> _showServiceDisabledDialog(
    ...
    final _ServiceDisabledChoice? value =
        await showDialog<_ServiceDisabledChoice>(
          context: context,
          builder: (BuildContext dialogContext) {
            return AlertDialog(
              ...
              actions: <Widget>[
                TextButton(
                  onPressed: () => Navigator.of(dialogContext).pop(
                    _ServiceDisabledChoice.manual,
                  ),
                  child: const Text('Enter Manually'),
                ),
                TextButton(
                  onPressed: () => Navigator.of(dialogContext).pop(
                    _ServiceDisabledChoice.cancel,
                  ),
                  child: const Text('Cancel'),
                ),
                FilledButton(
                  onPressed: () => Navigator.of(dialogContext).pop(
                    _ServiceDisabledChoice.settings,
                  ),
