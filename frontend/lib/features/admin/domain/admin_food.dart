...
class FoodType {
  const FoodType({required this.id, required this.label, this.colorIndex = 0});
...
class AdminFood {
  ...
  /// Lifecycle state used by freshness-aware admin lists. Archived food is
  /// retained for audit/history but excluded from the active catalogue.
  final String status;
