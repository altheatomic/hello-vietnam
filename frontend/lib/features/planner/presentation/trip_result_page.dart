  ...
  return plan.days.asMap().entries.map((entry) {
    ...
    final activities = day.places.map((TripPlanPlace p) {
      ...
      return TripPlannerActivityData(
        ...
        travelTimeCarSeconds: p.travelTimeCarSeconds,
        travelTimeBikeSeconds: p.travelTimeBikeSeconds,
        travelDistanceCarMeters: p.travelDistanceCarMeters,
        travelDistanceBikeMeters: p.travelDistanceBikeMeters,
