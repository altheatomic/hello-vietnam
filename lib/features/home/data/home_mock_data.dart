...
const List<Destination> mockDestinations = [
  Destination(
    ...
    rating: 4.33,
    imagePath: 'assets/images/destinations/nha_trang.jpg',
  ),
  Destination(
    id: '2',
    name: 'Da Lat',
  ...
  Destination(
    ...
    rating: 4.40,
    imagePath: 'assets/images/destinations/hcm.jpg',
  ),
  Destination(
    id: '4',
    name: 'Ha Noi',
    ...
    rating: 4.50,
    imagePath: 'assets/images/destinations/ha_noi.jpg',
  ),
];
...
const List<Dish> mockDishes = [
  Dish(
    ...
    rating: 4.33,
    imagePath: 'assets/images/dishes/bun_bo_hue.jpg',
  ),
  Dish(
    id: '2',
    name: 'Bun Ca',
    category: 'Traditional · Main course',
    rating: 4.20,
    imagePath: 'assets/images/dishes/bun_ca.jpg',
  ),
  Dish(
    id: '3',
    name: 'Pho',
    ...
    rating: 4.70,
    imagePath: 'assets/images/dishes/pho.jpg',
  ),
  Dish(
    id: '4',
    name: 'Banh Mi',
