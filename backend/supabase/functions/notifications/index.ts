...
import { SupabaseNotificationGateway } from "./notification_gateway.ts";
import {
...
Deno.serve(async (request: Request): Promise<Response> => {
  ...
  try {
    ...
    return withCors(await handleNotificationRequest({
      request,
      userId,
      gateway: new SupabaseNotificationGateway(serviceClient),
    }));
  } catch (error) {
