...
REGIONS = {
    ...
    'DBSCL': {'id_region': 'f483a1f6-f7b7-4925-bf8f-eb4e8b4b6681', 'id_zone': '60c29835-f8e0-4551-8e57-0b72c0c9e545'},
}
...
def fetch_overpass(city: CityTarget, category: str, retries: int = 4) -> List[Dict[str, Any]]:
    ...
    for attempt in range(retries):
        try:
            response = requests.post(OVERPASS_URL, data=query.encode('utf-8'), headers={'Accept': 'application/json'}, timeout=REQUEST_TIMEOUT_SECONDS)
